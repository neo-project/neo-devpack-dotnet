...
namespace DeploymentExample.Tests
{
    public abstract class ExampleContract : SmartContract, IContractInfo
    {
        ...
        protected ExampleContract(SmartContractInitialize initialize) : base(initialize)
        {
        }
