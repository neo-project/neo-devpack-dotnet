...
//
// SampleRoyaltyNEP11TokenRiscVTests.cs file belongs to the neo project and is free
...
[TestClass]
[TestCategory("RiscV")]
public class SampleRoyaltyNEP11TokenRiscVTests
{
    private static readonly string ContractProjectPath = Path.GetFullPath(
        Path.Combine("..", "..", "..", "..", "Example.SmartContract.SampleRoyaltyNEP11Token",
            "Example.SmartContract.SampleRoyaltyNEP11Token.csproj"));

    [TestMethod]
    public void SampleRoyaltyNEP11Token_CompilesForRiscV()
    {
        ...
        var ctx = contexts[0];
        Assert.IsTrue(ctx.Success, "SampleRoyaltyNEP11Token contract should compile successfully for RISC-V");
        Assert.AreEqual("SampleRoyaltyNEP11Token", ctx.ContractName);
    }

    [TestMethod]
    public void SampleRoyaltyNEP11Token_NeoVmAndRiscV_HaveSameContractName()
    {
