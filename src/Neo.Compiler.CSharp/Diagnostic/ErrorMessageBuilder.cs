...
namespace Neo.Compiler
{
    ...
    internal static class ErrorMessageBuilder
    {
        ...
        /// <summary>
        /// Gets location information as a formatted string.
        /// </summary>
        ...
        /// <summary>
        /// Gets a code snippet from the location if available.
        /// </summary>
        public static string GetCodeSnippet(Location? location, int maxLength = 100)
        {
            ...
            try
            {
                ...
                if (sourceText != null && span.Start >= 0 && span.End <= sourceText.Length)
                {
            ...
            {
                // If we can't get the snippet, return empty string
            }
