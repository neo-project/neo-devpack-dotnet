    ...
    internal partial class MethodConvert
    {
        ...
        private void ConvertDoStatement(SemanticModel model, DoStatementSyntax syntax)
        {
            ...
            if (_generalStatementStack.Pop() != sc)
                throw CompilationException.UnsupportedSyntax(syntax, "Internal compiler error: Statement stack mismatch in do-while statement handling. This is a compiler bug that should be reported.");
        }
    }
}
