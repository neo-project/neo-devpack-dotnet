...
{
    /// <summary>
    /// Represents debug information for a Neo smart contract as specified in NEP-19.
    /// </summary>
    /// <remarks>
    /// This class implements the debug information format used by the Neo Smart Contract Debugger.
    /// It is generated by smart contract compilers and provides additional type information
    /// about parameters, variables, and storage items, as well as source map information
    /// to map binary addresses in compiled contracts to locations in source code.
    /// 
    /// The debug info is stored in JSON format, either uncompressed with a ".debug.json" extension
    /// or compressed with a ".nefdbgnfo" extension.
    /// 
    /// For full specification, refer to NEP-19: Debug Info Specification.
    /// ref. https://github.com/neo-project/proposals/blob/master/nep-19.mediawiki
    /// </remarks>
