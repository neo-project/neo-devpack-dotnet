...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_NullableType : DebugAndTestBase<Contract_NullableType>
    {
        ...
        public void TestInt()
        {
            ...
            Assert.AreEqual(1048620, Engine.GasConsumed.Value);
            Assert.AreEqual(0, Contract.TestIntAdd(null, 1));
            Assert.AreEqual(1047480, Engine.GasConsumed.Value);
            Assert.AreEqual(3, Contract.TestIntAddNonNullable(1, 2));
            Assert.AreEqual(1047660, Engine.GasConsumed.Value);
        ...
        public void TestShort()
        {
            ...
            Assert.AreEqual(1048920, Engine.GasConsumed.Value);
            ...
            Assert.AreEqual(1047960, Engine.GasConsumed.Value);
        ...
        public void TestUInt160()
        {
            ...
            Assert.AreEqual(1047420, Engine.GasConsumed.Value);
            Assert.AreEqual(UInt160.Zero, Contract.TestUInt160Default(null));
            Assert.AreEqual(1047510, Engine.GasConsumed.Value);
            Assert.AreEqual(smaller, Contract.TestUInt160DefaultNonNullable(smaller));
            Assert.AreEqual(1047240, Engine.GasConsumed.Value);
        }
        ...
        public void TestArrays()
        {
            ...
            Assert.AreEqual(1109190, Engine.GasConsumed.Value);
            ...
            Assert.AreEqual(1108830, Engine.GasConsumed.Value);
            ...
            Assert.AreEqual(1108980, Engine.GasConsumed.Value);
        ...
        public void TestString()
        {
            ...
            Assert.AreEqual(1047720, Engine.GasConsumed.Value);
            ...
            Assert.AreEqual(1355100, Engine.GasConsumed.Value);
            Assert.AreEqual("test", Contract.TestStringConcat("test", null));
            Assert.AreEqual(1355190, Engine.GasConsumed.Value);
            Assert.AreEqual("testtest", Contract.TestStringConcatNonNullable("test", "test"));
            Assert.AreEqual(1354740, Engine.GasConsumed.Value);
        }
    }
}
