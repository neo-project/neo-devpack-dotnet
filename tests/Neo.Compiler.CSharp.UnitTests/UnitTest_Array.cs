...
//
// UnitTest_Array.cs file belongs to the neo project and is free
...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_Array : DebugAndTestBase<Contract_Array>
    {
        ...
        [TestMethod]
        public void Test_PushEmptyBuffer()
        {
            object? buffer = Contract.PushEmptyBuffer();
            Assert.IsNotNull(buffer);
            Assert.IsTrue(buffer is VM.Types.Buffer);
            Assert.AreEqual((buffer as VM.Types.Buffer)!.Size, 0);
        }
    }
}
