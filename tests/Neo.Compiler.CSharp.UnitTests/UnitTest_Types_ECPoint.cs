...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_Types_ECPoint : TestBase<Contract_Types_ECPoint>
    {
        ...
        public void ECPoint_test()
        {
            ...
            Assert.AreEqual("024700db2e90d9f02c4f9fc862abaca92725f95b4fddcc8d7ffa538693ecf463a9", Contract.Ecpoint2String()); // ERROR: Is converted to string, but in bytes
            Assert.AreEqual("024700db2e90d9f02c4f9fc862abaca92725f95b4fddcc8d7ffa538693ecf463a9", Contract.EcpointReturn()?.ToString());
            Assert.AreEqual("024700db2e90d9f02c4f9fc862abaca92725f95b4fddcc8d7ffa538693ecf463a9", Contract.Ecpoint2ByteArray()?.ToString());
        }
    }
}
