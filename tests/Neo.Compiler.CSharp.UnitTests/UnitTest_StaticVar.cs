...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_StaticVar : TestBase<Contract_StaticVar>
    {
        ...
        public void Test_InitialValue()
        {
            ...
            Assert.AreEqual(1004031940, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_StaticVar()
        {
            ...
            Assert.AreEqual(1004064340, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_testBigIntegerParse()
        {
            ...
            Assert.AreEqual(1004032300, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_testBigIntegerParse2()
        {
            ...
            Assert.AreEqual(1005080140, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_GetUInt160()
        {
            ...
            Assert.AreEqual(1004032000, Engine.FeeConsumed.Value);
        }
