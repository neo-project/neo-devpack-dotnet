...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_StaticVar : TestBase<Contract_StaticVar>
    {
        ...
        public void Test_StaticVar()
        {
            ...
            Assert.AreEqual(2988540, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_testBigIntegerParse()
        {
            ...
            Assert.AreEqual(2956500, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_testBigIntegerParse2()
        {
            ...
            Assert.AreEqual(4004340, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_GetUInt160()
        {
            ...
            Assert.AreEqual(2956200, Engine.FeeConsumed.Value);
        }
