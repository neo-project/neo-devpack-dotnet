...
namespace Neo.Compiler.CSharp.UnitTests
{
    ...
    public class UnitTest_BigInteger : TestBase<Contract_BigInteger>
    {
        ...
        public void Test_Pow()
        {
            ...
            Assert.AreEqual(1002124900, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_Sqrt()
        {
            ...
            Assert.AreEqual(1002124810, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_Sbyte()
        {
            ...
            Assert.AreEqual(1003171420, Engine.FeeConsumed.Value);
            Assert.ThrowsException<TestException>(() => Contract.Testsbyte(128));
            Assert.AreEqual(1004250010, Engine.FeeConsumed.Value);
            Assert.ThrowsException<TestException>(() => Contract.Testsbyte(-129));
            Assert.AreEqual(1005328600, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_ulong()
        {
            ...
            Assert.AreEqual(1003171690, Engine.FeeConsumed.Value);
            Assert.ThrowsException<TestException>(() => Contract.Testulong(BigInteger.Parse("18446744073709551616")));
            Assert.AreEqual(1004250460, Engine.FeeConsumed.Value);
        ...
        public void Test_IsEven()
        {
            ...
            Assert.AreEqual(1002123430, Engine.FeeConsumed.Value);

            // Test 1
            Assert.AreEqual(new BigInteger(1).IsEven, Contract.TestIsEven(1));
            Assert.AreEqual(1003171060, Engine.FeeConsumed.Value);

            // Test 2
            Assert.AreEqual(new BigInteger(2).IsEven, Contract.TestIsEven(2));
            Assert.AreEqual(1004218690, Engine.FeeConsumed.Value);

            // Test -1
            Assert.AreEqual(new BigInteger(-1).IsEven, Contract.TestIsEven(-1));
            Assert.AreEqual(1005266320, Engine.FeeConsumed.Value);

            // Test -2
            Assert.AreEqual(new BigInteger(-2).IsEven, Contract.TestIsEven(-2));
            Assert.AreEqual(1006313950, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_Negate()
        {
            ...
            Assert.AreEqual(1002123010, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_Compare()
        {
            ...
            Assert.AreEqual(1003170880, Engine.FeeConsumed.Value);
            Assert.AreEqual(BigInteger.Compare(123, -321), Contract.TestCompare(123, -321));
            Assert.AreEqual(1004218420, Engine.FeeConsumed.Value);
        }
        ...
        public void Test_GreatestCommonDivisor()
        {
            ...
            Assert.AreEqual(BigInteger.GreatestCommonDivisor(-48, -18), Contract.TestGreatestCommonDivisor(-48, -18));
            Assert.AreEqual(1003175380, Engine.FeeConsumed.Value);
            Assert.AreEqual(BigInteger.GreatestCommonDivisor(24, 12), Contract.TestGreatestCommonDivisor(24, 12));
            Assert.AreEqual(1004223550, Engine.FeeConsumed.Value);
        }
    }
}
