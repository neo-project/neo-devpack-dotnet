...
public abstract class Contract_Reentrancy(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// Script: WNgmHFkLCxPADG5vUmVlbnRyYW50Af8AEk00EmBYNC41M/7//1g1YQAAAEA=
    /// 00 : OpCode.LDSFLD0 [2 datoshi]
    /// 01 : OpCode.ISNULL [2 datoshi]
    /// 02 : OpCode.JMPIFNOT 1C [2 datoshi]
    /// 04 : OpCode.LDSFLD1 [2 datoshi]
    /// 05 : OpCode.PUSHNULL [1 datoshi]
    /// 06 : OpCode.PUSHNULL [1 datoshi]
    /// 07 : OpCode.PUSH3 [1 datoshi]
    /// 08 : OpCode.PACK [2048 datoshi]
    /// 09 : OpCode.PUSHDATA1 6E6F5265656E7472616E74 [8 datoshi]
    /// 16 : OpCode.PUSHINT16 FF00 [1 datoshi]
    /// 19 : OpCode.PUSH2 [1 datoshi]
    /// 1A : OpCode.PICK [2 datoshi]
    /// 1B : OpCode.CALL 12 [512 datoshi]
    /// 1D : OpCode.STSFLD0 [2 datoshi]
    /// 1E : OpCode.LDSFLD0 [2 datoshi]
    /// 1F : OpCode.CALL 2E [512 datoshi]
    /// 21 : OpCode.CALL_L 33FEFFFF [512 datoshi]
    /// 26 : OpCode.LDSFLD0 [2 datoshi]
    /// 27 : OpCode.CALL_L 61000000 [512 datoshi]
