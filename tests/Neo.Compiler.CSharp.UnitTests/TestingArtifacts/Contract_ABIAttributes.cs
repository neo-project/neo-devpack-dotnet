...
public abstract class Contract_ABIAttributes : Neo.SmartContract.Testing.SmartContract
{
    ...
    public static readonly Neo.SmartContract.Manifest.ContractManifest Manifest = Neo.SmartContract.Manifest.ContractManifest.Parse(@"{""name"":""Contract_ABIAttributes"",""groups"":[],""features"":{},""supportedstandards"":[],""abi"":{""methods"":[{""name"":""test"",""parameters"":[],""returntype"":""Integer"",""offset"":0,""safe"":false}],""events"":[]},""permissions"":[{""contract"":""0x01ff00ff00ff00ff00ff00ff00ff00ff00ff00a4"",""methods"":[""a"",""b""]},{""contract"":""*"",""methods"":[""c""]}],""trusts"":[""0x0a0b00ff00ff00ff00ff00ff00ff00ff00ff00a4""],""extra"":{""nef"":{""optimization"":""All""}}}");
