...
public abstract class Contract2_Inc_Dec : Neo.SmartContract.Testing.SmartContract
{
    ...
    protected Contract2_Inc_Dec(Neo.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
