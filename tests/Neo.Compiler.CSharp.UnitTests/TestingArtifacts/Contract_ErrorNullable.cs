...
public abstract class Contract_ErrorNullable : Neo.SmartContract.Testing.SmartContract
{
    ...
    public abstract void TestNullableString(object? a = null);
