...
public abstract class Contract_UIntTypes(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// Optimization: "All"
    /// </summary>
    public static Neo.SmartContract.NefFile Nef => Neo.IO.Helper.AsSerializable<Neo.SmartContract.NefFile>(Convert.FromBase64String(@"TkVGM1Rlc3RpbmdFbmdpbmUAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAF5XAAF4DBT2ZENJjTh40yuZTk4Sg8aTRCHa/pdAVwABeAwUAAAAAAAAAAAAAAAAAAAAAAAAAACXQFcAAXjbKErYJAlKygAUKAM6QFcAAXhK2ShQygAUs6skBAlAeLFA1omLJA=="));
    ...
    /// 04 : OpCode.PUSHDATA1 F66443498D3878D32B994E4E1283C6934421DAFE [8 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0001 [64 datoshi]
    /// 03 : OpCode.LDARG0 [2 datoshi]
    /// 04 : OpCode.PUSHDATA1 0000000000000000000000000000000000000000 [8 datoshi]
    /// 1A : OpCode.EQUAL [32 datoshi]
    /// 1B : OpCode.RET [0 datoshi]
    /// </remarks>
    ...
    /// 0C : OpCode.PUSHINT8 14 [1 datoshi]
    ...
    /// 09 : OpCode.PUSHINT8 14 [1 datoshi]
