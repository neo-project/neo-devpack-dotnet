...
public abstract class Contract_Out(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwEACQwAEBPAcGhKZxUQzkVoSmcWEc5FaEpnFxLORQlKY0pnGAtKYkpnGRBKYUpnGjUX/v//WV8VEFHQWl8WEVHQW18XElHQaBDOaBHOaBLOUxO/QA==
    /// INITSLOT 0100 [64 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSHDATA1 [8 datoshi]
    /// PUSH0 [1 datoshi]
