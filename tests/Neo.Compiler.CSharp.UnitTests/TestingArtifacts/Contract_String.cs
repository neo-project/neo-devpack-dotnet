...
public abstract class Contract_String(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 23 : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 003F : OpCode.CONVERT 'Buffer' [8192 datoshi]
    ...
    /// 007B : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 00AC : OpCode.CONVERT 'ByteString' [8192 datoshi]
    /// 00AE : OpCode.CAT [2048 datoshi]
    /// 00AF : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 00D1 : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 00EE : OpCode.CONVERT 'ByteString' [8192 datoshi]
    /// 00F0 : OpCode.CAT [2048 datoshi]
    /// 00F1 : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 013F : OpCode.CONVERT 'ByteString' [8192 datoshi]
    /// 0141 : OpCode.CAT [2048 datoshi]
    /// 0142 : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 4A : OpCode.CONVERT 'ByteString' [8192 datoshi]
    ...
    /// 2D : OpCode.CONVERT 'ByteString' [8192 datoshi]
