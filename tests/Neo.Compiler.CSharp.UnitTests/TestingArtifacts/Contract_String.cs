...
public abstract class Contract_String(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 23 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 007B : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 00AC : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    /// 00AE : OpCode.CAT [2048 datoshi]
    /// 00AF : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 00D1 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 00EE : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    /// 00F0 : OpCode.CAT [2048 datoshi]
    /// 00F1 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 0142 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 2D : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
