...
public abstract class Contract_Syscall_Out : Neo.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    protected Contract_Syscall_Out(Neo.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
