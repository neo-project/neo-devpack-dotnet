...
public abstract class Contract_NULL : Neo.SmartContract.Testing.SmartContract
{
    ...
    public abstract bool? EqualNotNullA(byte[]? value);

    /// <summary>
    /// Unsafe method
    /// </summary>
    [DisplayName("equalNotNullB")]
    public abstract bool? EqualNotNullB(byte[]? value);

    /// <summary>
    /// Unsafe method
    /// </summary>
    [DisplayName("equalNullA")]
    public abstract bool? EqualNullA(byte[]? value);

    /// <summary>
    /// Unsafe method
    /// </summary>
    [DisplayName("equalNullB")]
    public abstract bool? EqualNullB(byte[]? value);
    ...
    /// </summary>
    [DisplayName("isNull")]
    public abstract bool? IsNull(byte[]? value);
