...
public abstract class Contract_NULL(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// Script: 
    /// INITSLOT 0101 [64 datoshi]
    /// LDARG0 [2 datoshi]
    /// ISNULL [2 datoshi]
    /// JMPIF 05 [2 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: WNgkBVgiBQtKYEVYCJc5C2BY2CQFWCIFCUpgCZc5WUrYJgZFC0phRVkQlzkLYVlK2CYGRRFKYRGXOVlKnEoC////fzIeA/////8AAAAAkUoC////fzIMAwAAAAABAAAAn2FFWRKXOVmdSgIAAACALh4D/////wAAAACRSgL///9/MgwDAAAAAAEAAACfYVkRlzlA
    /// LDSFLD0 [2 datoshi]
    /// ISNULL [2 datoshi]
    /// JMPIF 05 [2 datoshi]
    /// LDSFLD0 [2 datoshi]
