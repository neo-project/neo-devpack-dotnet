...
public abstract class Contract_Linq(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 03 : OpCode.PUSHA 66000000	[4 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0001	[64 datoshi]
    /// 03 : OpCode.PUSHA 57000000	[4 datoshi]
    /// 08 : OpCode.LDARG0	[2 datoshi]
    /// 09 : OpCode.CALL 03	[512 datoshi]
    /// 0B : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 14 : OpCode.CALL_L BFFDFFFF	[512 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0001	[64 datoshi]
    /// 03 : OpCode.PUSHA D6000000	[4 datoshi]
    /// 08 : OpCode.LDARG0	[2 datoshi]
    /// 09 : OpCode.CALL 03	[512 datoshi]
    /// 0B : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 2C : OpCode.LDLOC2	[2 datoshi]
    /// 2D : OpCode.JMPLT E1	[2 datoshi]
    /// 2F : OpCode.NEWSTRUCT0	[16 datoshi]
    /// 30 : OpCode.DUP	[2 datoshi]
    /// 31 : OpCode.PUSHNULL	[1 datoshi]
    /// 32 : OpCode.APPEND	[8192 datoshi]
    /// 33 : OpCode.DUP	[2 datoshi]
    /// 34 : OpCode.PUSH0	[1 datoshi]
    ...
    /// 44 : OpCode.LDLOC1	[2 datoshi]
    /// 45 : OpCode.LDLOC0	[2 datoshi]
    /// 46 : OpCode.CALL_L D7FEFFFF	[512 datoshi]
    /// 4B : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 12 : OpCode.CALL_L 41FCFFFF	[512 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0001	[64 datoshi]
    /// 03 : OpCode.PUSHA 8A000000	[4 datoshi]
    /// 08 : OpCode.LDARG0	[2 datoshi]
    /// 09 : OpCode.CALL 03	[512 datoshi]
    /// 0B : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 04 : OpCode.PUSHA 57000000	[4 datoshi]
    /// 09 : OpCode.LDARG0	[2 datoshi]
    /// 0A : OpCode.CALL 03	[512 datoshi]
    /// 0C : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 16 : OpCode.PACK	[2048 datoshi]
    /// 17 : OpCode.DUP	[2 datoshi]
    /// 18 : OpCode.CALL_L 69FEFFFF	[512 datoshi]
    ...
    /// 38 : OpCode.CALL_L 46FFFFFF	[512 datoshi]
    ...
    /// 11 : OpCode.CALL_L 59F8FFFF	[512 datoshi]
    /// 16 : OpCode.PUSH0	[1 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0001	[64 datoshi]
    /// 03 : OpCode.PUSHA 85000000	[4 datoshi]
    /// 08 : OpCode.LDARG0	[2 datoshi]
    /// 09 : OpCode.CALL 03	[512 datoshi]
    /// 0B : OpCode.RET	[0 datoshi]
    /// </remarks>
    ...
    /// 00 : OpCode.INITSLOT 0001	[64 datoshi]
    /// 03 : OpCode.PUSHA 5A000000	[4 datoshi]
    /// 08 : OpCode.LDARG0	[2 datoshi]
    /// 09 : OpCode.CALL 03	[512 datoshi]
    /// 0B : OpCode.RET	[0 datoshi]
    /// </remarks>
