...
public abstract class Contract_Linq(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 3E : LDLOC1 [2 datoshi]
    /// 3F : LDLOC0 [2 datoshi]
    /// 40 : CALL_L 6CFFFFFF [512 datoshi]
    /// 45 : RET [0 datoshi]
    /// </remarks>
    ...
    /// 2C : LDLOC0 [2 datoshi]
    /// 2D : LDARG1 [2 datoshi]
    /// 2E : PICKITEM [64 datoshi]
    /// 2F : STLOC1 [2 datoshi]
    /// 30 : LDLOC1 [2 datoshi]
    /// 31 : LDLOC0 [2 datoshi]
    /// 32 : CALL_L 34FFFFFF [512 datoshi]
    /// 37 : RET [0 datoshi]
    /// </remarks>
    ...
    /// 3E : LDLOC1 [2 datoshi]
    /// 3F : LDLOC0 [2 datoshi]
    /// 40 : CALL_L EEFEFFFF [512 datoshi]
    /// 45 : RET [0 datoshi]
    /// </remarks>
    ...
    /// 29 : LDLOC2 [2 datoshi]
    /// 2A : JMPLT E4 [2 datoshi]
    /// 2C : PUSHA 0C000000 [4 datoshi]
    /// 31 : LDLOC0 [2 datoshi]
    /// 32 : CALL_L 4DFFFFFF [512 datoshi]
    /// 37 : RET [0 datoshi]
    /// </remarks>
    ...
    /// 08 : LDARG0 [2 datoshi]
    /// 09 : CALL_L 1AFDFFFF [512 datoshi]
    /// 0E : STLOC0 [2 datoshi]
