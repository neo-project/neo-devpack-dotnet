...
public abstract class Contract_NEP11(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 43 : OpCode.SYSCALL 9BF667CE 'System.Storage.GetContext' [16 datoshi]
    ...
    /// 53 : OpCode.SYSCALL DF30B89A 'System.Storage.Find' [32768 datoshi]
    ...
    /// 41 : OpCode.SYSCALL 9BF667CE 'System.Storage.GetContext' [16 datoshi]
    ...
    /// 50 : OpCode.SYSCALL 925DE831 'System.Storage.Get' [32768 datoshi]
    ...
    /// 5E : OpCode.SYSCALL F827EC8C 'System.Runtime.CheckWitness' [1024 datoshi]
    ...
    /// 80 : OpCode.SYSCALL E63F1884 'System.Storage.Put' [32768 datoshi]
