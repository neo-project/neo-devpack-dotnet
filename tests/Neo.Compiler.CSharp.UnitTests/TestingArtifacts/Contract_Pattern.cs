...
public abstract class Contract_Pattern(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    public static Neo.SmartContract.Manifest.ContractManifest Manifest => Neo.SmartContract.Manifest.ContractManifest.Parse(@"{""name"":""Contract_Pattern"",""groups"":[],""features"":{},""supportedstandards"":[],""abi"":{""methods"":[{""name"":""between"",""parameters"":[{""name"":""value"",""type"":""Integer""}],""returntype"":""Boolean"",""offset"":0,""safe"":false},{""name"":""between2"",""parameters"":[{""name"":""value"",""type"":""Integer""}],""returntype"":""Boolean"",""offset"":17,""safe"":false},{""name"":""between3"",""parameters"":[{""name"":""value"",""type"":""Integer""}],""returntype"":""Boolean"",""offset"":34,""safe"":false},{""name"":""testRecursivePattern"",""parameters"":[],""returntype"":""Boolean"",""offset"":79,""safe"":false},{""name"":""testRecursivePatternAllMatch"",""parameters"":[],""returntype"":""Boolean"",""offset"":151,""safe"":false},{""name"":""testRecursivePatternSecondMismatch"",""parameters"":[],""returntype"":""Boolean"",""offset"":218,""safe"":false},{""name"":""testRecursivePatternShortCircuitOnFirstMismatch"",""parameters"":[],""returntype"":""Boolean"",""offset"":267,""safe"":false},{""name"":""testRecursivePatternEmptyPropertyPatternForNull"",""parameters"":[],""returntype"":""Boolean"",""offset"":363,""safe"":false},{""name"":""testRecursivePatternEmptyPropertyPatternForValue"",""parameters"":[],""returntype"":""Boolean"",""offset"":374,""safe"":false},{""name"":""between4"",""parameters"":[{""name"":""value"",""type"":""Integer""}],""returntype"":""Boolean"",""offset"":397,""safe"":false},{""name"":""testNotPattern"",""parameters"":[{""name"":""x"",""type"":""Boolean""}],""returntype"":""Boolean"",""offset"":406,""safe"":false},{""name"":""classify"",""parameters"":[{""name"":""measurement"",""type"":""Integer""}],""returntype"":""String"",""offset"":415,""safe"":false},{""name"":""getCalendarSeason"",""parameters"":[{""name"":""month"",""type"":""Integer""}],""returntype"":""String"",""offset"":522,""safe"":false},{""name"":""testDeclarationPattern"",""parameters"":[],""returntype"":""Void"",""offset"":684,""safe"":false},{""name"":""testTypePattern"",""parameters"":[{""name"":""o1"",""type"":""Any""}],""returntype"":""Void"",""offset"":771,""safe"":false},{""name"":""testTypePattern2"",""parameters"":[{""name"":""t"",""type"":""Any""}],""returntype"":""Integer"",""offset"":793,""safe"":false}],""events"":[]},""permissions"":[{""contract"":""0xacce6fd80d44e1796aa0c2c625e9e4e0ce39efc0"",""methods"":[""itoa""]}],""trusts"":[],""extra"":{""Version"":""3.10.0"",""nef"":{""optimization"":""All""}}}");

    /// <summary>
    /// Optimization: "All"
    /// </summary>
    public static Neo.SmartContract.NefFile Nef => Convert.FromBase64String(@"").AsSerializable<Neo.SmartContract.NefFile>();
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwIADBQAAAAAAAAAAAAAAAAAAAAAAAAAAHBocWnYJgUJIhJpStkoJAZFCSIGygAUswiXJAUJIgdpsaoIlyYECEAIJgQJQGk6
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwIACQkSwAkIEk00JnBocWnYJgUJIgdpEM4IlyQFCSIHaRHOCZcmBAhACCYECUBpOg==
    /// INITSLOT 0200 [64 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSH2 [1 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwIACQkSwAgIEk01R////3BocWnYqkA=
    /// INITSLOT 0200 [64 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSH2 [1 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwIACQkSwAgIEk0043BocWnYJgUJIgdpEM4IlyQFCSIHaRHOCZcmBAhACCYECUBpOg==
    /// INITSLOT 0200 [64 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSHF [1 datoshi]
    /// PUSH2 [1 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwIAwnBocWnYJgUJIgdpNBcIlyQFCSIFaTQSJgQIQAgmBAlAaTo=
    /// INITSLOT 0200 [64 datoshi]
