...
public abstract class Contract_Enum(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 0A : OpCode.PUSHDATA1 56616C756533 [8 datoshi]
    /// 12 : OpCode.PUSHDATA1 56616C756532 [8 datoshi]
    /// 1A : OpCode.PUSHDATA1 56616C756531 [8 datoshi]
    ...
    /// 3A : OpCode.DROP [2 datoshi]
    /// 3B : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 41 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
