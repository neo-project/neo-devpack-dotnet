...
namespace Neo.SmartContract.Testing.UnitTests
{
    ...
    public class NativeArtifactsTests
    {
        ...
        public void TestInitialize()
        {
            ...
            Assert.AreEqual(1F, engine.Native.NEO.GetCoverage(o => o.Symbol).CoveredLinesPercentage);
            Assert.AreEqual(1F, engine.Native.NEO.GetCoverage(o => o.TotalSupply).CoveredLinesPercentage);
            Assert.AreEqual(1F, engine.Native.NEO.GetCoverage(o => o.BalanceOf(It.IsAny<UInt160>())).CoveredLinesPercentage);
        }
