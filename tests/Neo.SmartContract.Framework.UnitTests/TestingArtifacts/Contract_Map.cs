...
public abstract class Contract_Map(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 05 : OpCode.PUSHDATA1 74657374626F6F6C 'testbool' [8 datoshi]
    ...
    /// 03 : OpCode.NEWMAP [8 datoshi]
    /// 04 : OpCode.STLOC0 [2 datoshi]
    /// 05 : OpCode.PUSHDATA1 74657374737472696E6732 'teststring2' [8 datoshi]
    ...
    /// 03 : OpCode.NEWMAP [8 datoshi]
    /// 04 : OpCode.STLOC0 [2 datoshi]
    /// 05 : OpCode.PUSHDATA1 74657374646573657269616C697A65 'testdeserialize' [8 datoshi]
    ...
    /// 03 : OpCode.NEWMAP [8 datoshi]
    /// 04 : OpCode.STLOC0 [2 datoshi]
    /// 05 : OpCode.PUSHDATA1 737472696E67 'string' [8 datoshi]
    ...
    /// 03 : OpCode.NEWMAP [8 datoshi]
    /// 04 : OpCode.STLOC0 [2 datoshi]
    /// 05 : OpCode.PUSHDATA1 0000000000000000000000000000000000000000 [8 datoshi]
    /// 1B : OpCode.STLOC1 [2 datoshi]
    /// 1C : OpCode.PUSH1 [1 datoshi]
    /// 1D : OpCode.DUP [2 datoshi]
    ...
    /// 24 : OpCode.CALLT 0000 [32768 datoshi]
    /// 27 : OpCode.STLOC2 [2 datoshi]
    /// 28 : OpCode.LDLOC2 [2 datoshi]
    /// 29 : OpCode.CALLT 0100 [32768 datoshi]
    ...
    /// 03 : OpCode.NEWMAP [8 datoshi]
    /// 04 : OpCode.STLOC0 [2 datoshi]
    /// 05 : OpCode.PUSHDATA1 313239383430746573743130303232393339 '129840test10022939' [8 datoshi]
    ...
    /// 06 : OpCode.DUP [2 datoshi]
    /// 07 : OpCode.PUSHDATA1 6162 'ab' [8 datoshi]
