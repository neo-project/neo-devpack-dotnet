...
public abstract class Contract_Crypto(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 04 : OpCode.CALLT 0500 [32768 datoshi]
    ...
    /// 06 : OpCode.CALLT 0800 [32768 datoshi]
    ...
    /// 03 : OpCode.LDARG1 [2 datoshi]
    /// 04 : OpCode.LDARG0 [2 datoshi]
    /// 05 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    /// 07 : OpCode.CALLT 0200 [32768 datoshi]
    /// 0A : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 09 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 0A : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
