...
public abstract class Contract_Attribute(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// Script: XNgmH1sLCxPADAtub1JlZW50cmFudAH/ABJNNXX///9kXDSKNUf///9cNMJA
    /// LDSFLD4 [2 datoshi]
    /// ISNULL [2 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: WtgmHFsLCxPADAtub1JlZW50cmFudAH/ABJNNApiWjQiWjRfQA==
    /// LDSFLD2 [2 datoshi]
    /// ISNULL [2 datoshi]
    ...
    /// </summary>
    /// <remarks>
    /// Script: WNgmKVkLEsAMHEFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQT0RTTQIYFg0HwhA
    /// LDSFLD0 [2 datoshi]
    /// ISNULL [2 datoshi]
