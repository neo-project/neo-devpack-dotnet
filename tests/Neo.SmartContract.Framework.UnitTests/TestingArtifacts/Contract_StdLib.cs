...
public abstract class Contract_StdLib : Neo.SmartContract.Testing.SmartContract
{
    ...
    protected Contract_StdLib(Neo.SmartContract.Testing.SmartContractInitialize initialize) : base(initialize) { }
