...
public abstract class Contract_Helper(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// RET [0 datoshi]
    /// </remarks>
    [DisplayName("bigIntegerToSbyte")]
    public abstract BigInteger? BigIntegerToSbyte(BigInteger? value);
    ...
    /// RET [0 datoshi]
    /// </remarks>
    [DisplayName("intToSbyte")]
    public abstract BigInteger? IntToSbyte(BigInteger? value);
