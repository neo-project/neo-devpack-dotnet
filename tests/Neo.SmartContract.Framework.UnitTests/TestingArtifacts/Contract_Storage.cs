...
public abstract class Contract_Storage(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 07 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 15 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 12 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 0C : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 0E : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 1F : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 21 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 17 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 26 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 1B : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 2A : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 23 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 16 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 19 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 49 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 0007 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 003E : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 0040 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 0070 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 0072 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 00A4 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 00A6 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 0152 : OpCode.CONVERT 33 'Integer' [8192 datoshi]
    ...
    /// 1D : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 33 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    /// 35 : OpCode.PUSHDATA1 01 [8 datoshi]
    /// 38 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 3A : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    /// 3C : OpCode.LDLOC1 [2 datoshi]
    ...
    /// 4A : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    /// 4C : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 59 : OpCode.CONVERT 48 'Buffer' [8192 datoshi]
    ...
    /// 18 : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
    ...
    /// 1E : OpCode.CONVERT 40 'ByteString' [8192 datoshi]
