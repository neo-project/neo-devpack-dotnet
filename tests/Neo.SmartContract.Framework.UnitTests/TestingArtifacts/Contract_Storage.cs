...
public abstract class Contract_Storage(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// 07 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 1D : OpCode.SYSCALL 2F58C5ED 	-> 0 datoshi
    ...
    /// 0B : OpCode.SYSCALL 9BF667CE 	-> 0 datoshi
    ...
    /// 1C : OpCode.SYSCALL 2F58C5ED 	-> 0 datoshi
    ...
    /// 09 : OpCode.SYSCALL 9BF667CE 	-> 0 datoshi
    ...
    /// 1A : OpCode.SYSCALL 2F58C5ED 	-> 0 datoshi
    ...
    /// 03 : OpCode.SYSCALL F6B46BE2 	-> 0 datoshi
    /// 08 : OpCode.STLOC0 	-> 2 datoshi
    ...
    /// 17 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 1F : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    /// 24 : OpCode.STLOC2 	-> 2 datoshi
    /// 25 : OpCode.LDLOC2 	-> 2 datoshi
    /// 26 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 09 : OpCode.STLOC0 	-> 2 datoshi
    /// 0A : OpCode.SYSCALL 9BF667CE 	-> 0 datoshi
    /// 0F : OpCode.SYSCALL 764CBFE9 	-> 0 datoshi
    ...
    /// 1B : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 23 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    /// 28 : OpCode.STLOC3 	-> 2 datoshi
    /// 29 : OpCode.LDLOC3 	-> 2 datoshi
    /// 2A : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 03 : OpCode.PUSHDATA1 6161 	-> 8 datoshi
    /// 07 : OpCode.STLOC0 	-> 2 datoshi
    /// 08 : OpCode.SYSCALL F6B46BE2 	-> 0 datoshi
    ...
    /// 1A : OpCode.CAT 	-> 2048 datoshi
    /// 1B : OpCode.SWAP 	-> 2 datoshi
    /// 1C : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    /// 21 : OpCode.STLOC3 	-> 2 datoshi
    /// 22 : OpCode.LDLOC3 	-> 2 datoshi
    /// 23 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 16 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 1E : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 19 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 2E : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 44 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    /// 49 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 0007 : OpCode.CONVERT 30 	-> 8192 datoshi
    /// 0009 : OpCode.STLOC0 	-> 2 datoshi
    /// 000A : OpCode.SYSCALL 9BF667CE 	-> 0 datoshi
    ...
    /// 003E : OpCode.CONVERT 30 	-> 8192 datoshi
    /// 0040 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 0070 : OpCode.CONVERT 30 	-> 8192 datoshi
    /// 0072 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 00A4 : OpCode.CONVERT 30 	-> 8192 datoshi
    /// 00A6 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 00C2 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 00D3 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 00E7 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 00FC : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 0112 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 0128 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 0139 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    ...
    /// 014D : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    /// 0152 : OpCode.CONVERT 21 	-> 8192 datoshi
    ...
    /// 0164 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    ...
    /// 017A : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    ...
    /// 0190 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    ...
    /// 01A6 : OpCode.SYSCALL 925DE831 	-> 0 datoshi
    ...
    /// 42 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    /// 47 : OpCode.PUSHDATA1 01 	-> 8 datoshi
    /// 4A : OpCode.CONVERT 30 	-> 8192 datoshi
    /// 4C : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 59 : OpCode.CONVERT 30 	-> 8192 datoshi
    ...
    /// 18 : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 20 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 1D : OpCode.CAT 	-> 2048 datoshi
    /// 1E : OpCode.SWAP 	-> 2 datoshi
    /// 1F : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    /// 24 : OpCode.PUSHT 	-> 1 datoshi
    /// 25 : OpCode.RET 	-> 0 datoshi
    /// </remarks>
    ...
    /// 1E : OpCode.CONVERT 28 	-> 8192 datoshi
    ...
    /// 26 : OpCode.SYSCALL E63F1884 	-> 0 datoshi
    ...
    /// 1B : OpCode.CAT 	-> 2048 datoshi
    /// 1C : OpCode.SWAP 	-> 2 datoshi
    /// 1D : OpCode.SYSCALL E63F1884 	-> 0 datoshi
