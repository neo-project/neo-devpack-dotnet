...
public abstract class Contract_Storage : Neo.SmartContract.Testing.SmartContract, IContractInfo
{
    ...
    /// Unsafe method
    /// </summary>
    [DisplayName("testIndexGetInteger")]
    public abstract BigInteger? TestIndexGetInteger(byte[]? key);
