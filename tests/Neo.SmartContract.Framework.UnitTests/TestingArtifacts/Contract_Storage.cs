...
public abstract class Contract_Storage(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// Script: VwQCDAIBqtswcEGb9mfOcWhpEsByEBHASjQVShB50HNreGo0E3hqNCNzaxDOQA==
    ...
    /// 20 : OpCode.LDLOC3 [2 datoshi]
    /// 21 : OpCode.LDARG0 [2 datoshi]
    /// 22 : OpCode.LDLOC2 [2 datoshi]
    /// 23 : OpCode.CALL 13 [512 datoshi]
    /// 25 : OpCode.LDARG0 [2 datoshi]
    /// 26 : OpCode.LDLOC2 [2 datoshi]
    /// 27 : OpCode.CALL 23 [512 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0201 [64 datoshi]
    /// 03 : OpCode.PUSHDATA1 6161 'aa' [8 datoshi]
    ...
    /// 12 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 17 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 26 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    ...
    /// 1B : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 2A : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    ...
    /// 00 : OpCode.INITSLOT 0401 [64 datoshi]
    /// 03 : OpCode.PUSHDATA1 6969 'ii' [8 datoshi]
    /// 07 : OpCode.STLOC0 [2 datoshi]
    /// 08 : OpCode.SYSCALL F6B46BE2 'System.Storage.GetReadOnlyContext' [16 datoshi]
    /// 0D : OpCode.STLOC1 [2 datoshi]
    /// 0E : OpCode.LDLOC0 [2 datoshi]
    ...
    /// 16 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 19 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 1B : OpCode.STLOC3 [2 datoshi]
    /// 1C : OpCode.LDLOC3 [2 datoshi]
    /// 1D : OpCode.PUSHDATA1 627974654172726179 'byteArray' [8 datoshi]
    ...
    /// 33 : OpCode.PUSHDATA1 627974654172726179 'byteArray' [8 datoshi]
    ...
    /// 49 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    ...
    /// 003E : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 0040 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 0070 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 0072 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 00A4 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 00A6 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 00B6 : OpCode.PUSHDATA1 626F6F6C 'bool' [8 datoshi]
    ...
    /// 00C8 : OpCode.PUSHDATA1 696E74 'int' [8 datoshi]
    ...
    /// 00D9 : OpCode.PUSHDATA1 737472696E67 'string' [8 datoshi]
    ...
    /// 00ED : OpCode.PUSHDATA1 75696E74313630 'uint160' [8 datoshi]
    ...
    /// 0103 : OpCode.PUSHDATA1 75696E74323536 'uint256' [8 datoshi]
    ...
    /// 0119 : OpCode.PUSHDATA1 6563706F696E74 'ecpoint' [8 datoshi]
    ...
    /// 012D : OpCode.PUSHDATA1 626F6F6C 'bool' [8 datoshi]
    ...
    /// 0142 : OpCode.PUSHDATA1 696E74 'int' [8 datoshi]
    ...
    /// 0152 : OpCode.CONVERT 21 'Integer' [8192 datoshi]
    /// 0154 : OpCode.STLOC 0A [2 datoshi]
    /// 0156 : OpCode.PUSHDATA1 737472696E67 'string' [8 datoshi]
    ...
    /// 016B : OpCode.PUSHDATA1 75696E74313630 'uint160' [8 datoshi]
    ...
    /// 0181 : OpCode.PUSHDATA1 75696E74323536 'uint256' [8 datoshi]
    ...
    /// 0197 : OpCode.PUSHDATA1 6563706F696E74 'ecpoint' [8 datoshi]
    ...
    /// 20 : OpCode.PUSHDATA1 746573745F6D6170 'test_map' [8 datoshi]
    ...
    /// 33 : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    /// 35 : OpCode.PUSHDATA1 01 [8 datoshi]
    /// 38 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 3A : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    /// 3C : OpCode.LDLOC1 [2 datoshi]
    ...
    /// 4A : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    /// 4C : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
    ...
    /// 59 : OpCode.CONVERT 30 'Buffer' [8192 datoshi]
    ...
    /// 1E : OpCode.CONVERT 28 'ByteString' [8192 datoshi]
