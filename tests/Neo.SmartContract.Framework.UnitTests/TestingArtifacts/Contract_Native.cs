...
public abstract class Contract_Native(Neo.SmartContract.Testing.SmartContractInitialize initialize) : Neo.SmartContract.Testing.SmartContract(initialize), IContractInfo
{
    ...
    /// <remarks>
    /// Script: NwgAQA==
    /// 00 : OpCode.CALLT 0800 	-> 32768 datoshi
    ...
    /// <remarks>
    /// Script: NwcAQA==
    /// 00 : OpCode.CALLT 0700 	-> 32768 datoshi
    /// 03 : OpCode.RET 	-> 0 datoshi
    /// </remarks>
    ...
    /// 07 : OpCode.CALLT 0100 	-> 32768 datoshi
    ...
    /// <remarks>
    /// Script: NwkAQA==
    /// 00 : OpCode.CALLT 0900 	-> 32768 datoshi
    /// 03 : OpCode.RET 	-> 0 datoshi
    /// </remarks>
    ...
    /// 00 : OpCode.INITSLOT 0001 	-> 64 datoshi
    /// 03 : OpCode.LDARG0 	-> 2 datoshi
    /// 04 : OpCode.CALLT 0A00 	-> 32768 datoshi
    /// 07 : OpCode.RET 	-> 0 datoshi
    /// </remarks>
