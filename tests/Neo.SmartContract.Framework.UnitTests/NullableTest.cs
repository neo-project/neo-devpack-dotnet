...
//         {
//             Assert.IsTrue(Contract.H160NullableNotEqual(UInt160.Zero, UInt160.Parse("NXV7ZhHiyM1aHXwpVsRZC6BwNFP2jghXAq")));
...
//             Assert.IsFalse(Contract.H256NullableEqual(UInt256.Zero, UInt256.Zero));
//         }
//
//         [TestMethod]
...
//
//         [TestMethod]
//         public void TestCharNullableToString()
//         {
//             Assert.IsTrue(Contract.CharNullableToString('a'));
//             Assert.IsFalse(Contract.CharNullableToString(null));
//         }
//
//         [TestMethod]
