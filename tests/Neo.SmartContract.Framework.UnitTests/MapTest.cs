...
namespace Neo.SmartContract.Framework.UnitTests
{
    ...
    public class MapTest : TestBase<Contract_Map>
    {
        ...
        public void TestCount()
        {
            ...
            Assert.AreEqual(2036880, Engine.FeeConsumed.Value);
        }
        ...
        public void TestByteArray()
        {
            ...
            Assert.AreEqual(2645610, Engine.FeeConsumed.Value);
        }
        ...
        public void TestClear()
        {
            ...
            Assert.AreEqual(2646150, Engine.FeeConsumed.Value);
        }
        ...
        public void TestByteArray2()
        {
            ...
            Assert.AreEqual(3936390, Engine.FeeConsumed.Value);
        }
        ...
        public void TestUnicodeKeyValue()
        {
            ...
            Assert.AreEqual(2399910, Engine.FeeConsumed.Value);
        }
        ...
        public void TestDeserialize()
        {
            ...
            Assert.AreEqual(3874560, Engine.FeeConsumed.Value);
        ...
        public void TestUInt160KeyDeserialize()
        {
            ...
            Assert.AreEqual(3813420, Engine.FeeConsumed.Value);
