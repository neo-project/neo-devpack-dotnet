    ...
    public class ContractInvocationBasicTest
    {
        ...
        public void Test_ContractInvocation_AllTypesExist()
        {
            ...
            string[] expectedTypes = new[]
            {
                ...
                "Neo.SmartContract.Framework.ContractInvocation.ContractConstants",
                "Neo.SmartContract.Framework.ContractInvocation.ContractInterfaceGenerator",
                "Neo.SmartContract.Framework.ContractInvocation.IBlockchainInterface",
                "Neo.SmartContract.Framework.ContractInvocation.CompilationTimeBlockchainInterface",
                "Neo.SmartContract.Framework.ContractInvocation.RuntimeBlockchainInterface",
                "Neo.SmartContract.Framework.ContractInvocation.Exceptions.ContractInvocationException",
                "Neo.SmartContract.Framework.ContractInvocation.Exceptions.MethodNotFoundException",
                "Neo.SmartContract.Framework.ContractInvocation.Exceptions.ContractNotResolvedException",
                "Neo.SmartContract.Framework.ContractInvocation.MethodResolutionInfo",
