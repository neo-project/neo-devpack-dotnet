...
namespace Neo.SmartContract.Framework.UnitTests
{
    ...
    public class StringTest : TestBase<Contract_String>
    {
        ...
        public void TestStringAdd()
        {
            ...
            Assert.AreEqual(1002418330, Engine.FeeConsumed.Value);

            // hello => 4
            Assert.AreEqual(4, Contract.TestStringAdd("he", "llo"));
            Assert.AreEqual(1003774930, Engine.FeeConsumed.Value);

            // world => 5
            Assert.AreEqual(5, Contract.TestStringAdd("wo", "rld"));
            Assert.AreEqual(1005132790, Engine.FeeConsumed.Value);
        }
        ...
        public void TestStringAddInt()
        {
            ...
            Assert.AreEqual(1003521220, Engine.FeeConsumed.Value);
        }
    }
}
