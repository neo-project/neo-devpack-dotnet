...
namespace Neo.SmartContract.Framework.UnitTests.Old
{
    ...
    public class HelperTest
    {
        ...
        public void Init()
        {
            ...
            _engine.AddEntryScript(Extensions.TestContractRoot + "Contract_Helper.cs");
        }
        ...
        public void TestAssert()
        {
            ...
            var logsMethod = new System.EventHandler<LogEventArgs>((sender, e) => { logList.Add(e.Message); });
