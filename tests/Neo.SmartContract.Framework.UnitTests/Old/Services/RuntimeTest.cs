...
namespace Neo.SmartContract.Framework.UnitTests.Old.Services
{
    ...
    public class RuntimeTest
    {
        ...
        public void Test_GetNotificationsCount()
        {
            ...
            _engine.SendTestNotification(UInt160.Zero, "", new Array(_engine.ReferenceCounter, new StackItem[] { new Integer(0x01) }));
            _engine.SendTestNotification(UInt160.Parse("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"), "", new Array(_engine.ReferenceCounter, new StackItem[] { new Integer(0x02) }));
